    ...
    return <section aria-label="Worker runtime interface prerequisite state" className="mt-3 rounded border border-slate-800 p-3 text-sm">
        ...
        {typeof state === "object" && <>
            ...
            <details className="mt-3">
                ...
                <p>v0.61 retains the Core-owned v0.57 interface prerequisite inventory integrated through v0.60. Successor runtime definition and presentation remain deferred; no new runtime authority is established.</p>
