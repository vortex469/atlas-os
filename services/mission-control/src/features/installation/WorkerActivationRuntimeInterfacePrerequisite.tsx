...
function InventoryReader({ review }: { review: WorkerActivationRuntimePlanReview }) {
    ...
    return <section aria-label="Worker runtime interface prerequisite state" className="mt-3 rounded border border-slate-800 p-3 text-sm">
        <h6 className="font-semibold">Worker runtime interface prerequisite evidence</h6>
        <p>Interface prerequisite inventory is evidence; runtime prerequisites remain incomplete. Worker start and execution remain blocked.</p>
        ...
        {typeof state === "object" && <>
            ...
            <details className="mt-3">
                <summary>Advanced v0.57 evidence</summary>
