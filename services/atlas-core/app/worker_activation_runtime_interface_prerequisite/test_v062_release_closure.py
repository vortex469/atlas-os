"""Retained v0.62 closure must not reserve a successor consumer or schema."""
...
def test_v062_no_successor_or_operational_consumer():
    forbidden = tuple(
        marker
...
def test_v062_shared_envelopes_reject_successor_authority(
