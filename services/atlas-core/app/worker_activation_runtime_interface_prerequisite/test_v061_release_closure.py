"""Retained v0.61 closure must not reserve a successor consumer or schema."""
...
def test_v061_no_successor_or_operational_consumer():
    forbidden = tuple(
        marker
...
def test_v061_shared_envelopes_reject_successor_authority(
