...
INSTALLATION_CONTROLLED_WORKER_QUEUE_CLAIM_LEASE_ACK_ADMISSION_RECORD = (
    "installation.execution."
    "controlled_worker_queue_claim_lease_acknowledgement_admission.record"
)
INSTALLATION_CONTROLLED_WORKER_QUEUE_CLAIM_LEASE_ACK_ADMISSION_READ = (
    "installation.execution."
    "controlled_worker_queue_claim_lease_acknowledgement_admission.read"
)
...
INSTALLATION_CONTROLLED_WORKER_QUEUE_CLAIM_LEASE_ACK_READ = (
    "installation.execution.controlled_worker_queue_claim_lease_acknowledgement.read"
)
...
INSTALLATION_WORKER_ACTIVATION_RUNTIME_DEFINITION_EVALUATE = (
    "installation.execution.worker_activation_runtime_definition.evaluate"
)
INSTALLATION_WORKER_ACTIVATION_RUNTIME_DEFINITION_READ = (
    "installation.execution.worker_activation_runtime_definition.read"
)
